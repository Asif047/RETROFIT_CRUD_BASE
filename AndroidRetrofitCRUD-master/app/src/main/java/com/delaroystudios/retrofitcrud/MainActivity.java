...
public class MainActivity extends AppCompatActivity {
    ...
    String BASE_URL = "http://asifulhaque047.000webhostapp.com";

    EditText edt_name, edt_age, edt_mobile, edt_mail, edt_image;
    ...
    private void checkNetwork() {
        ...
        if (!networkUtil.isNetworkAvailable()) {
            networkUtil.showNoNetworkDialog("Ther is no internet connction");

            return;
        }

        if (!networkUtil.isGPSon()) {
            networkUtil.showNoNetworkDialog("Ther is no GPS connction");
        }
